...
public class MarioRender extends JComponent implements FocusListener {
    ...
    public MarioRender(float scale) {
        ...
        Dimension size = new Dimension((int) (MarioGame.width * scale), (int) (MarioGame.height * scale));
    ...
    public void renderWorld(MarioWorld world, Image image, Graphics g, Graphics og) {
        og.fillRect(0, 0, MarioGame.width, MarioGame.height);
        world.render(og);
        ...
        if (scale > 1) {
            g.drawImage(image, 0, 0, (int) (MarioGame.width * scale), (int) (MarioGame.height * scale), null);
        } else {
